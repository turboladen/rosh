require 'spec_helper'
require 'rosh/host/file_system_objects/local_file'
require 'tempfile'


describe Rosh::Host::FileSystemObjects::LocalFile do
  let(:file) do
  ...
  subject { Rosh::Host::FileSystemObjects::LocalFile.new(file.path) }
