require 'spec_helper'
require 'rosh/host/environment'


describe Rosh::Host::Environment do
  ...
  subject do
    Rosh::Host::Environment.new(ssh_hostname)
  end

  before do
    Rosh::Environment.stub_chain(:hosts, :[], :shell).and_return shell
  end
  ...
  describe '#shell' do
    before do
      result.stub_chain(:ssh_result, :stdout).and_return 'test'
    end
